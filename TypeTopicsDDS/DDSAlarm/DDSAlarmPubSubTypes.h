...
#ifndef _DDSALARM_PUBSUBTYPES_H_
#define _DDSALARM_PUBSUBTYPES_H_
...
#error Generated DDSAlarm is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
#endif  // GEN_API_VER
...
#endif // _DDSALARM_PUBSUBTYPES_H_